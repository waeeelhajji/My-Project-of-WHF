...
{ catg: "Vegetarian Food", img: "../WHPHoto/VGFood/nusi-Gareng.PNG", name: " Nasi Goreng ", price: 35, description: "(Indonesian Fried Rice) loaded up with fresh veggies! Add an egg or keep it vegan! An easy tasty vegetarian recipe that can be made in minutes!", time: 1 },
{ catg: "Vegetarian Food", img: "../WHPHoto/VGFood/Roasted-chile-rellenas-recipe.PNG", name: " Roasted Chile Rellenos Recipe  ", price: 28, description: "a lightened up recipe (with the addition of black beans) and simplified by roasting (instead of frying) the peppers and the Rancheros sauce ingredients all together on one sheet-pan – saving a step! Delicious and satisfying! ", time: 8 },
{ catg: "Vegetarian Food", img: "../WHPHoto/VGFood/farmers-market-vegetarian.PNG", name: " Farmers Market Vegetarian Enchiladas   ", price: 29, description: "with black beans and your choice of veggies (like red bell pepper, sweet potato zucchini or corn) and Homemade 5 Minute Enchilada Sauce! Easy, Healthy and full of delicious Mexican Flavor! Vegan and Gluten-free adaptable! ", time: 5 },
...
{ catg: "Indian Food", img: "../WHPHoto/INFood/chicken-vindaloo.PNG", name: "chicken vindaloo curry.", description: "This is a mild and sweetly spiced recipe for chicken vindaloo curry. Contrary to current belief, curries do not have to be hot and fiery and, in fact, never started out that way in India. Creating the curry paste is the most important part of this dish, so don't skimp on the ingredients.", price: 19, time: 17 },
{ catg: "Indian Food", img: "../WHPHoto/INFood/rogan-josh.PNG", name: "Rogan Josh", description: "the name of this dish from Kashmir, translates roughly to red lamb. The color comes from Kashmiri dry red chilies. While the name may sound fiery, the heat of the dish is toned down by the cream that is added at the end", price: 12, time: 17 },
